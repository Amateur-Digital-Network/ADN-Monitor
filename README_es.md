...
**Versión 2.6** — emparejado con **adn-server 2.6** (report v2 slim wire + HELLO JSON).
...
5. **adn-server** **2.6** (report v2 slim wire + HELLO JSON; actualiza/reinicia si el footer muestra una versión antigua del servidor).
